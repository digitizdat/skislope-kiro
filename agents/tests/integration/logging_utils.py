...
from .config import TestConfig, LogLevel
from .models import DiagnosticData, TestError, Severity
...
class DiagnosticCollector:
    ...
    def save_diagnostics(self, filepath: Optional[Path] = None) -> Path:
...
class TestArtifactManager:
    ...
    def cleanup_artifacts(self, max_age_days: Optional[int] = None) -> None:
...
def create_test_error(message: str, category: str, severity: Severity = Severity.HIGH, 
                     context: Optional[Dict[str, Any]] = None, 
                     suggested_fix: Optional[str] = None) -> TestError:
