...
class ExampleTestRunner:
    ...
    def setup_recovery_strategies(self):
        ...
        recovery_manager.register_recovery_strategy(
            "no module named", fix_imports, RetryConfig(max_attempts=2, base_delay=1.0)
        )
    ...
    async def run_test_with_error_handling(
        ...
        try:
            ...
            test_result = (
                await self.error_handler.recovery_manager.execute_with_recovery(
                    test_func,
    ...
    async def demonstrate_error_scenarios(self):
        ...
        # Export diagnostics
        self.error_handler.export_diagnostics(
            "temp/error_handling_demo_diagnostics.json"
        )
        logger.info(
            "📊 Diagnostics exported to temp/error_handling_demo_diagnostics.json"
        )
    ...
    async def handle_api_contract_error():
        ...
        try:
            ...
            raise AttributeError(
                "'AgentClient' object has no attribute 'get_weather_data'"
            )
...
async def main():
    ...
    await runner.demonstrate_error_scenarios()
