...
from .environment_validator import EnvironmentValidationResult
from .environment_validator import EnvironmentValidator
from .environment_validator import PackageInfo
...
class TestEnvironmentValidator:
    ...
    def test_validate_python_environment_uv_missing(self, mock_run):
        ...
        uv_issues = [
            issue for issue in self.validator.issues if issue.component == "uv"
        ]
    ...
    def test_validate_package_manager_consistency_mixed_managers(
        self, mock_detect, mock_exists
    ):
    ...
    def test_detect_mixed_package_managers(self, mock_run):
        ...
        mock_run.return_value = Mock(
            returncode=0, stdout='[{"name": "fastapi", "version": "0.68.0"}]'
        )
    ...
    def test_validate_import_dependencies_failures(self, mock_import):
        ...
        import_issues = [
            issue for issue in self.validator.issues if issue.component == "imports"
        ]
    ...
    def test_validate_ssl_configuration_success(self, mock_create_context):
        ...
        ssl_issues = [
            issue for issue in self.validator.issues if issue.component == "ssl"
        ]
    ...
    def test_generate_fix_script_no_issues(self):
        ...
        with patch.object(
            self.validator, "validate_environment", return_value=mock_result
        ):
            script = self.validator.generate_fix_script()
...
class TestPackageInfo:
    ...
    def test_package_info_optional_installer(self):
        ...
        pkg = PackageInfo(name="fastapi", version="0.68.0", location="/path/to/package")
