...
class ConfigManager:
    ...
    def __init__(self):
        self._config: TestConfig | None = None
    ...
    def get_config(self, overrides: dict[str, Any] | None = None) -> TestConfig:
...
def get_test_config(overrides: dict[str, Any] | None = None) -> TestConfig:
