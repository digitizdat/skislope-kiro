...
from agents.equipment.models import EquipmentRequest, LiftType, TrailDifficulty, FacilityType
...
class TestEquipmentService:
    ...
    async def test_generate_facilities(self, equipment_service, sample_request):
        ...
        ski_area = equipment_service.ski_areas["chamonix"]
        facilities = await equipment_service._generate_facilities(sample_request, ski_area)
    ...
    async def test_generate_safety_equipment(self, equipment_service, sample_request):
        ...
        ski_area = equipment_service.ski_areas["chamonix"]
        safety_equipment = await equipment_service._generate_safety_equipment(sample_request, ski_area)
...
class TestEquipmentModels:
    ...
    def test_lift_info_validation(self):
        ...
        from agents.equipment.models import LiftInfo, LiftStatus
