...
from agents.hill_metrics.models import GeographicBounds, GridSize, TerrainRequest
...
class TestDEMProcessor:
    ...
    @pytest.mark.asyncio
    async def test_process_terrain_with_surface_classification(self, dem_processor, sample_bounds):
...
class TestTerrainModels:
    ...
    def test_geographic_bounds_validation(self):
        ...
        with pytest.raises(ValueError):
            GeographicBounds(north=100.0, south=45.0, east=7.0, west=6.0)  # Invalid latitude
