...
from agents.shared.utils import retry_with_backoff
...
class WeatherService:
    ...
    async def _generate_synthetic_forecast(
        ...
        for i in range(days):
            ...
            forecast.append(WeatherForecast(
                ...
                precipitation_mm=random.uniform(0, 15) if random.random() > 0.6 else 0,
    ...
    async def _generate_synthetic_historical(
        ...
        for i in range(days):
            ...
            historical.append(HistoricalWeatherData(
                ...
                precipitation_mm=random.uniform(0, 20) if random.random() > 0.7 else 0,
    ...
    def _analyze_ski_conditions(
        ...
        if weather.wind.speed_kmh > 30:
            safety_warnings.append("High wind conditions - exercise caution on exposed slopes")
